...
namespace PM25onWinPhone.Utils
{
    ...
    class SharedNetwork
    {
        ...
        {
            interfaceFlag = 1;
            sendRequest(PMURL.GetAllCites1);
        }
                    ...
                    try
                    {
                        switch (interfaceFlag)
                        {
                            ...
                            case 3:
                                ...
                                System.Diagnostics.Debug.WriteLine("==========testing3" + cityStaionsAir.data[0].PositionName + "=========");
                                break;
                            case 4:
        ...
        public void getCityAir(string cityName)
        {
          Entity.cityData theCity = Cites.Find(
            ...
            if(theCity != null)
            {
                ...
                sendRequest(PMURL.GetCityAirByCityId1 + theCity.cityid);
            }
            else
            {
        ...
        public void getSationAir(string cityName)
        {
            Entity.cityData theCity = Cites.Find(
                delegate (Entity.cityData cityData)
                {
            ...
            if (theCity != null)
            {
                ...
                sendRequest(PMURL.GetSitesAirByCityId1 + theCity.cityid);
            }
            else
            {
                System.Diagnostics.Debug.WriteLine("sorry, we still don't have the data of this city");
